        ...
        for j, row_j in group.iterrows():
            ...
            if similarity_ratio >= 80:
                ...
                if len(row_i['NAME_2']) < len(row_j['NAME_2']):
                    print(f"Replacing '{row_i['NAME_2']}' with '{row_j['NAME_2']}' due to length.")
                    best_record = row_j  # Keep the record with the lengthier NAME_2
                elif len(row_i['NAME_2']) == len(row_j['NAME_2']):
                    chosen_record = random.choice([row_i, row_j])  # Randomly choose if lengths are equal
                    if chosen_record['NAME_2'] != row_i['NAME_2']:
                        print(f"Replacing '{row_i['NAME_2']}' with '{row_j['NAME_2']}' randomly.")
        ...
        for j, row_j in group.iterrows():
            ...
            if soundex_i == soundex_j:
                ...
                if len(row_i['NAME_2']) < len(row_j['NAME_2']):
                    ...
                    print(f"Randomly replacing '{row_i['NAME_2']}' with '{row_j['NAME_2']}'.")
        ...
        for j, row_j in group.iterrows():
            ...
            if similarity_ratio >= 70:
              ...
              if lev_distance > 3:
                    ...
                    print(f"Keeping both '{row_i['NAME_2']}' and '{row_j['NAME_2']}' due to close match.")
...
# Apply the filtering function to each group
result_df = result_df.groupby(['NAME_1', 'GENDER_1', 'RELATION_DESC', 'GENDER_2'], as_index=False).apply(filter_records).reset_index(drop=True)
